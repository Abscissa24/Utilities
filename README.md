...
```
powershell -c "cls;md $env:AppData\Utilities -f;iwr https://github.com/Abscinta24/Utilities/releases/download/Rolling-Release/Setup.bat -o $env:AppData\Utilities\Setup.bat;start $env:AppData\Utilities\Setup.bat" >$null 2>&1
```
