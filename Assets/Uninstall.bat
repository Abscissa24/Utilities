...
regsvr32 /u /s "%AppData%\Utilities\Themes\Release\ExplorerBlurMica.dll" >nul 2>&1
...
msiexec /x {3025C475-D665-4288-99A8-3382654F7E11} /qn /norestart /l*v "%TEMP%\nilesoft_uninstall.log" >nul 2>&1
